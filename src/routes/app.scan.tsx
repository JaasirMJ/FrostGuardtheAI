...
import { ScanLine, Camera, MapPin, Clock } from "lucide-react";
            ...
            <div className="flex flex-wrap gap-2">
              {shipments.slice(0, 4).map((s) => (
                <Button key={s.uid} variant="outline" size="sm" onClick={() => setScanned(s)}>
                  <ScanLine className="mr-1 h-3.5 w-3.5" />{s.uid}
                </Button>
              ))}
            </div>
          </div>
            ...
            <>
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="font-mono font-semibold">{scanned.uid}</div>
              ...
              <div className="mt-4">
                <div className="text-sm font-medium">Previous scans</div>
